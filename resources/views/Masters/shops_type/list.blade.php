...
<div class="table-responsive">
    ...
    <tr>
        ...
        <td class="stl"><?php echo  ucfirst($shops_type1['shops_type']); ?></td>
        <td align="center" class="stl">
            <div class="pretty p-default p-curve p-toggle">
                <input type="checkbox" <?php if ($shops_type1['status1']=="1"){ echo 'checked'; }else{ } ?> onclick="change_fun('<?php echo $shops_type1['id']; ?>','<?php echo $shops_type1['status1']; ?>')">
