...
<div class="table-responsive">
    ...
    <tr>
        ...
        <td class="stl"><?php echo  ucfirst($designation_creation1['designation_name']); ?></td>
        ...
        <a class="btn btn-icon icon-left btn-info hover-gradient" data-toggle="tooltip" style="cursor: pointer" title="Edit" onclick="open_model('Update Designation Creation','<?php echo $designation_creation1['id']; ?>')"><i class="far fa-edit"></i>Edit</a>
        <?php } ?>
