...
@section('page_title','Designation Creation')
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4> <span class="label info small">Designation Master</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
            <button type="submit" class="button" onclick="open_model('Designation Creation','')">Create</button>
